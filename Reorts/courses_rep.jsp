...
<report name="courses_rep" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL COURSE.COURSE_ID, 
COURSE.COURSE_NAME, COURSE.COURSE_DESC, COURSE.SCHOOL_YR
FROM COURSE ]]>
      </select>
      ...
      <group name="G_COURSE_ID">
        ...
        />
        <dataItem name="COURSE_ID" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Course Id">
          <dataDescriptor expression="COURSE.COURSE_ID"
           descriptiveExpression="COURSE_ID" order="1" width="22"
           precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COURSE_NAME" datatype="vchar2" columnOrder="12"
         width="255" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Course Name">
          <dataDescriptor expression="COURSE.COURSE_NAME"
           descriptiveExpression="COURSE_NAME" order="2" width="255"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COURSE_DESC" datatype="vchar2" columnOrder="13"
         width="255" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Course Desc">
          <dataDescriptor expression="COURSE.COURSE_DESC"
           descriptiveExpression="COURSE_DESC" order="3" width="255"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SCHOOL_YR" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="School Yr">
          <dataDescriptor expression="COURSE.SCHOOL_YR"
           descriptiveExpression="SCHOOL_YR" order="4" width="22"
           precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
  ...
  <section name="main">
    <body>
      <frame name="M_G_COURSE_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="5.75000" height="0.37500"
        />
        ...
        <repeatingFrame name="R_G_COURSE_ID" source="G_COURSE_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="5.75000"
           height="0.18750"/>
          ...
          <field name="F_COURSE_NAME" source="COURSE_NAME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="1.43750" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_COURSE_DESC" source="COURSE_DESC" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.87500" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SCHOOL_YR" source="SCHOOL_YR" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.31250" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_COURSE_ID_HDR">
          <geometryInfo x="0.00000" y="0.00000" width="5.75000"
           height="0.18750"/>
          ...
          <text name="B_COURSE_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.43750" y="0.00000" width="1.43750"
             height="0.18750"/>
          ...
          <text name="B_COURSE_DESC" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.87500" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_SCHOOL_YR" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.31250" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
<rw:dataArea id="MGCOURSEIDGRPFR97">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBCOURSEID97" asArray="no"/> class="OraColumnHeader"> Course Id </th>
   <th <rw:id id="HBCOURSENAME97" asArray="no"/> class="OraColumnHeader"> Course Name </th>
   <th <rw:id id="HBCOURSEDESC97" asArray="no"/> class="OraColumnHeader"> Course Desc </th>
   <th <rw:id id="HBSCHOOLYR97" asArray="no"/> class="OraColumnHeader"> School Yr </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGCOURSEID971" src="G_COURSE_ID">
   <tr>
    <td <rw:headers id="HFCOURSEID97" src="HBCOURSEID97"/> class="OraCellNumber"><rw:field id="FCOURSEID97" src="COURSE_ID" nullValue="&nbsp;"> F_COURSE_ID </rw:field></td>
    <td <rw:headers id="HFCOURSENAME97" src="HBCOURSENAME97"/> class="OraCellText"><rw:field id="FCOURSENAME97" src="COURSE_NAME" nullValue="&nbsp;"> F_COURSE_NAME </rw:field></td>
    <td <rw:headers id="HFCOURSEDESC97" src="HBCOURSEDESC97"/> class="OraCellText"><rw:field id="FCOURSEDESC97" src="COURSE_DESC" nullValue="&nbsp;"> F_COURSE_DESC </rw:field></td>
    <td <rw:headers id="HFSCHOOLYR97" src="HBSCHOOLYR97"/> class="OraCellNumber"><rw:field id="FSCHOOLYR97" src="SCHOOL_YR" nullValue="&nbsp;"> F_SCHOOL_YR </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
