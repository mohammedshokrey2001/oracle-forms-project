...
<report name="student_rep_3" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="STUDENT_REP_3" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL STUDENT.STUD_ID, STUDENT.FNAME, STUDENT.LNAME, STUDENT.GENDER, STUDENT.AGE, 
...
FROM STUDENT ]]>
      ...
      <group name="G_GENDER">
        ...
        <summary name="AvgAGEPerGENDER" source="AGE" function="average"
         width="22" precision="38" reset="G_GENDER" compute="report"
         defaultWidth="100000" defaultHeight="10000" columnFlags="552"
         defaultLabel="Average:">
          <displayInfo x="0.00000" y="0.00000" width="0.00000"
           height="0.00000"/>
        </summary>
        <summary name="CountSTUD_IDPerGENDER" source="STUD_ID"
      ...
      <group name="G_STUD_ID">
        <displayInfo x="1.26746" y="3.49951" width="1.46521" height="1.51929"
        />
        <dataItem name="STUD_ID" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Stud Id">
          <dataDescriptor expression="STUDENT.STUD_ID"
           descriptiveExpression="STUD_ID" order="1" width="22" precision="38"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
    ...
    <summary name="AvgAGEPerReport" source="AGE" function="average" width="22"
     precision="38" reset="report" compute="report" defaultWidth="100000"
     defaultHeight="10000" columnFlags="552" defaultLabel="Average:">
      <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"/>
    </summary>
  </data>
  <layout>
  <section name="main">
    <body>
      <frame name="M_G_GENDER_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.50000" height="1.12500"
        />
         ...
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_GENDER" source="GENDER" minWidowLines="1" spacing="0"
           alignment="start">
            ...
            />
            <geometryInfo x="0.50000" y="0.00000" width="1.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <frame name="M_G_STUD_ID_GRPFR">
            <geometryInfo x="0.00000" y="0.18750" width="7.50000"
             height="0.75000"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_STUD_ID" source="G_STUD_ID"
             printDirection="down" minWidowRecords="1" columnMode="no">
              ...
              <field name="F_FNAME" source="FNAME" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="1.56250" y="0.37500" width="0.87500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              ...
              <field name="F_AGE" source="AGE" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="3.31250" y="0.37500" width="1.56250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_STUD_NUMBER" source="STUD_NUMBER"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.87500" y="0.37500" width="0.87500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_STUD_EMAIL" source="STUD_EMAIL" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="5.75000" y="0.37500" width="0.87500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_STUD_PASS" source="STUD_PASS" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="6.62500" y="0.37500" width="0.87500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_STUD_ID_FTR">
              ...
              <field name="F_AvgAGEPerGENDER" source="AvgAGEPerGENDER"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="3.31250" y="0.56250" width="1.56250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_CountSTUD_IDPerGENDER"
               source="CountSTUD_IDPerGENDER" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="0.00000" y="0.75000" width="1.56250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            ...
            <frame name="M_G_STUD_ID_HDR">
              ...
              <text name="B_FNAME" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="1.56250" y="0.18750" width="0.87500"
                 height="0.18750"/>
              ...
              <text name="B_LNAME" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.43750" y="0.18750" width="0.87500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_AGE" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="3.31250" y="0.18750" width="1.56250"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="TableHeading"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_STUD_NUMBER" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.87500" y="0.18750" width="0.87500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_STUD_EMAIL" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="5.75000" y="0.18750" width="0.87500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_STUD_PASS" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="6.62500" y="0.18750" width="0.87500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
        ...
        <frame name="M_G_GENDER_FTR">
          <geometryInfo x="0.00000" y="0.93750" width="7.50000"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_AvgAGEPerReport" source="AvgAGEPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.62500" y="0.93750" width="1.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_AvgAGEPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <field name="F_CountSTUD_IDPerReport" source="CountSTUD_IDPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="2.68750" y="0.93750" width="1.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_CountSTUD_IDPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.18750" y="0.93750" width="0.50000"
             height="0.18750"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"/>
              <string>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="masterDetail" versionFlags2="0"
   templateName="rwgreen" sectionTitle="Students"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGGENDERGRPFR139">
<rw:foreach id="RGGENDER1391" src="G_GENDER">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader"> Students <br>Gender <rw:field id="F_GENDER" src="GENDER" breakLevel="RGGENDER1391" breakValue="&nbsp;"> F_GENDER </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    <td valign="top">
    <table class="OraTable" summary="Students">
     <!-- Header -->
     <thead>
      <tr>
       <th <rw:id id="HBSTUDID139" asArray="no"/> class="OraColumnHeader"> Stud Id </th>
       <th <rw:id id="HBFNAME139" asArray="no"/> class="OraColumnHeader"> Fname </th>
       <th <rw:id id="HBLNAME139" asArray="no"/> class="OraColumnHeader"> Lname </th>
       <th <rw:id id="HBAGE139" asArray="no"/> class="OraColumnHeader"> Age </th>
       <th <rw:id id="HBSTUDNUMBER139" asArray="no"/> class="OraColumnHeader"> Stud Number </th>
       <th <rw:id id="HBSTUDEMAIL139" asArray="no"/> class="OraColumnHeader"> Stud Email </th>
       <th <rw:id id="HBSTUDPASS139" asArray="no"/> class="OraColumnHeader"> Stud Pass </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGSTUDID1391" src="G_STUD_ID">
       <tr>
        <td <rw:headers id="HFSTUDID139" src="HBSTUDID139"/> class="OraCellNumber"><rw:field id="FSTUDID139" src="STUD_ID" nullValue="&nbsp;"> F_STUD_ID </rw:field></td>
        <td <rw:headers id="HFFNAME139" src="HBFNAME139"/> class="OraCellText"><rw:field id="FFNAME139" src="FNAME" nullValue="&nbsp;"> F_FNAME </rw:field></td>
        <td <rw:headers id="HFLNAME139" src="HBLNAME139"/> class="OraCellText"><rw:field id="FLNAME139" src="LNAME" nullValue="&nbsp;"> F_LNAME </rw:field></td>
        <td <rw:headers id="HFAGE139" src="HBAGE139"/> class="OraCellNumber"><rw:field id="FAGE139" src="AGE" nullValue="&nbsp;"> F_AGE </rw:field></td>
        <td <rw:headers id="HFSTUDNUMBER139" src="HBSTUDNUMBER139"/> class="OraCellText"><rw:field id="FSTUDNUMBER139" src="STUD_NUMBER" nullValue="&nbsp;"> F_STUD_NUMBER </rw:field></td>
        <td <rw:headers id="HFSTUDEMAIL139" src="HBSTUDEMAIL139"/> class="OraCellText"><rw:field id="FSTUDEMAIL139" src="STUD_EMAIL" nullValue="&nbsp;"> F_STUD_EMAIL </rw:field></td>
        <td <rw:headers id="HFSTUDPASS139" src="HBSTUDPASS139"/> class="OraCellText"><rw:field id="FSTUDPASS139" src="STUD_PASS" nullValue="&nbsp;"> F_STUD_PASS </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      ...
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFAvgAGEPerGENDER139" src="HBAGE139"/> class="OraTotalNumber">Average: <rw:field id="FAvgAGEPerGENDER139" src="AvgAGEPerGENDER" nullValue="&nbsp;"> F_AvgAGEPerGENDER </rw:field></td>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
     </tr>
     <tr>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFCountSTUDIDPerGENDER139" src="HBSTUDID139"/> class="OraTotalNumber">Count: <rw:field id="FCountSTUDIDPerGENDER139" src="CountSTUD_IDPerGENDER" nullValue="&nbsp;"> F_CountSTUD_IDPerGENDER </rw:field></td>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
     ...
     <tr>
      <td  class="OraTotalNumber">Gender <rw:field id="FGENDER139" src="GENDER" nullValue="&nbsp;"> F_GENDER </rw:field></td>
     </tr>
    </table>
   </td>
  </tr>
...
<table class="OraTable" summary="Students">
 <tr>
  <th class="OraTotalNumber"> Average: <rw:field id="F_AvgAGEPerReport" src="AvgAGEPerReport" nullValue="&nbsp;"> F_AvgAGEPerReport </rw:field></th>
  <th class="OraTotalNumber"> Count: <rw:field id="F_CountSTUD_IDPerReport" src="CountSTUD_IDPerReport" nullValue="&nbsp;"> F_CountSTUD_IDPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGGENDERGRPFR139" -->
