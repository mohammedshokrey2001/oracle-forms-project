...
<report name="Tranactions_rep" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL TRANSACTIONS.TRANS_ID, 
TRANSACTIONS.TRANS_NAME, TRANSACTIONS.TRANS_DATE, TRANSACTIONS.STUD_ID
FROM TRANSACTIONS ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_TRANS_ID">
        <displayInfo x="1.30408" y="1.94995" width="1.39197" height="0.97949"
        />
        <dataItem name="TRANS_ID" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Trans Id">
          <dataDescriptor expression="TRANSACTIONS.TRANS_ID"
           descriptiveExpression="TRANS_ID" order="1" width="22"
           precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TRANS_NAME" datatype="vchar2" columnOrder="12"
         width="255" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Trans Name">
          <dataDescriptor expression="TRANSACTIONS.TRANS_NAME"
           descriptiveExpression="TRANS_NAME" order="2" width="255"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TRANS_DATE" datatype="date" oracleDatatype="date"
         columnOrder="13" width="9" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="Trans Date">
          <dataDescriptor expression="TRANSACTIONS.TRANS_DATE"
           descriptiveExpression="TRANS_DATE" order="3" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="STUD_ID" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Stud Id">
          <dataDescriptor expression="TRANSACTIONS.STUD_ID"
           descriptiveExpression="STUD_ID" order="4" width="22" precision="38"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountTRANS_IDPerReport" source="TRANS_ID" function="count"
      ...
      <frame name="M_G_TRANS_ID_GRPFR">
        ...
        <repeatingFrame name="R_G_TRANS_ID" source="G_TRANS_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_TRANS_ID" source="TRANS_ID" minWidowLines="1"
          ...
          <field name="F_TRANS_NAME" source="TRANS_NAME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
          ...
          <field name="F_TRANS_DATE" source="TRANS_DATE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="3.00000" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_STUD_ID" source="STUD_ID" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.43750" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_TRANS_ID_FTR">
          ...
          <field name="F_CountTRANS_IDPerReport"
           source="CountTRANS_IDPerReport" minWidowLines="1" spacing="0"
           alignment="start">
        ...
        <frame name="M_G_TRANS_ID_HDR">
          ...
          <text name="B_TRANS_ID" minWidowLines="1">
          ...
          <text name="B_TRANS_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_TRANS_DATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.00000" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_STUD_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.43750" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwblue" sectionTitle="Tranactions"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGTRANSIDGRPFR182">
<table class="OraTable">
<caption> Tranactions </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBTRANSID182" asArray="no"/> class="OraColumnHeader"> Trans Id </th>
   <th <rw:id id="HBTRANSNAME182" asArray="no"/> class="OraColumnHeader"> Trans Name </th>
   <th <rw:id id="HBTRANSDATE182" asArray="no"/> class="OraColumnHeader"> Trans Date </th>
   <th <rw:id id="HBSTUDID182" asArray="no"/> class="OraColumnHeader"> Stud Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGTRANSID1821" src="G_TRANS_ID">
   <tr>
    <td <rw:headers id="HFTRANSID182" src="HBTRANSID182"/> class="OraCellNumber"><rw:field id="FTRANSID182" src="TRANS_ID" nullValue="&nbsp;"> F_TRANS_ID </rw:field></td>
    <td <rw:headers id="HFTRANSNAME182" src="HBTRANSNAME182"/> class="OraCellText"><rw:field id="FTRANSNAME182" src="TRANS_NAME" nullValue="&nbsp;"> F_TRANS_NAME </rw:field></td>
    <td <rw:headers id="HFTRANSDATE182" src="HBTRANSDATE182"/> class="OraCellText"><rw:field id="FTRANSDATE182" src="TRANS_DATE" nullValue="&nbsp;"> F_TRANS_DATE </rw:field></td>
    <td <rw:headers id="HFSTUDID182" src="HBSTUDID182"/> class="OraCellNumber"><rw:field id="FSTUDID182" src="STUD_ID" nullValue="&nbsp;"> F_STUD_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 <!-- Report Level Summary -->
 <tr>
  <td <rw:headers id="HFCountTRANSIDPerReport182" src="HBTRANSID182"/> class="OraTotalNumber">Count: <rw:field id="FCountTRANSIDPerReport182" src="CountTRANS_IDPerReport" nullValue="&nbsp;"> F_CountTRANS_IDPerReport </rw:field></td>
